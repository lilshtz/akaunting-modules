<x-layouts.admin>
    <x-slot name="title">{{ $employee->name }} {{ trans('payroll::general.payslip_history') }}</x-slot>
            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b">
                        ...
                        <th class="px-4 py-3 text-left text-sm font-medium text-gray-500">{{ trans('payroll::general.gross') }}</th>
                        <th class="px-4 py-3 text-left text-sm font-medium text-gray-500">{{ trans('payroll::general.deductions') }}</th>
                ...
                <tbody>
                    @forelse ($payslips as $payslip)
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-3 text-sm">{{ money($payslip->gross, setting('default.currency', 'USD')) }}</td>
                            <td class="px-4 py-3 text-sm">{{ money($payslip->total_deductions, setting('default.currency', 'USD')) }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-4 py-6 text-center text-sm text-gray-500">{{ trans('general.no_records') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
