...
@section('title', trans('general.edit') . ' ' . trans('bank-feeds::general.rule'))

@section('content')
    <div class="card">
        <form action="{{ route('bank-feeds.rules.update', $rule->id) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="field" id="field" class="form-control" required>
                                @foreach($fields as $field)
                                    <option value="{{ $field }}" {{ old('field', $rule->field) == $field ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select name="operator" id="operator" class="form-control" required>
                                @foreach($operators as $op)
                                    <option value="{{ $op }}" {{ old('operator', $rule->operator) == $op ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="value" id="value" class="form-control" value="{{ old('value', $rule->value) }}" required>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="category_id" id="category_id" class="form-control" value="{{ old('category_id', $rule->category_id) }}" placeholder="Category ID">
                            @error('category_id')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" name="vendor_id" id="vendor_id" class="form-control" value="{{ old('vendor_id', $rule->vendor_id) }}" placeholder="Vendor ID (optional)">
                            @error('vendor_id')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="number" name="priority" id="priority" class="form-control" value="{{ old('priority', $rule->priority) }}" min="0">
                            @error('priority')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group mt-4">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="enabled" value="1" class="custom-control-input" id="enabled" {{ old('enabled', $rule->enabled) ? 'checked' : '' }}>
