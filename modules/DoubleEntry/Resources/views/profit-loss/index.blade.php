            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="bg-gray-100">
                        <td colspan="{{ $comparative && $priorData ? 4 : 3 }}" class="px-6 py-2 text-sm font-bold">{{ trans('double-entry::general.types.income') }}</td>
                    </tr>
                    ...
                    {{-- EXPENSES --}}
                    <tr class="bg-gray-100">
                        <td colspan="{{ $comparative && $priorData ? 4 : 3 }}" class="px-6 py-2 text-sm font-bold">{{ trans('double-entry::general.types.expense') }}</td>
                    </tr>
